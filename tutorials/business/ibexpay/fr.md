...
Remplissez les différentes informations liées à votre commerce puis choisissez le pays dans lequel vous avez implanté votre commerce : cette étape est importante pour la devise qui sera utilisée pour encaisser les paiements.
...
Vous pouvez aussi assigner un manager différent pour chacun de vos comptes (boutiques). Pour cela, dans le menu **Managers**, créez un directeur de boutique en renseignant le nom du superviseur du magasin et son adresse e-mail. Ce superviseur recevra automatiquement un mail d'invitation afin de pouvoir administrer la boutique qui lui sera assignée.
