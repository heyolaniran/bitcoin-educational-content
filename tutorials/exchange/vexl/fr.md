...
Partout dans le monde, des solutions naissent dans le but de rendre l'usage de Bitcoin plus accessible et plus sûr. Dans cette catégorie, Vexl se démarque particulièrement par son approche et sa vision : Remettre Bitcoin aux mains des populations.

Vexl est un réseau social pair à pair qui a la particularité de connecter des vendeurs et des acheteurs de bitcoin partout dans le monde. Il ne nécessite aucune vérification d'identité et améliore votre confidentialité en ne divulguant aucune de vos informations sensibles.

## Premiers pas avec Vexl
...
Après la vérification de votre compte, commencez à découvrir les membres du réseau qui sont dans vos contacts. Importez vos contacts puis commencez par utiliser Vexl.
...
- Acheter un produit avec du bitcoin.
- Vendre un produit en échange de bitcoins.
- Voir toutes les offres de vente de bitcoin dans votre région.
- Voir toutes les offres d'achat de bitcoin dans votre région.
- Rechercher quelque chose de particulier.
...
Retrouvez également les évènements Bitcoin d'actualités
