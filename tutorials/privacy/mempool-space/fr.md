...
Les mineurs sont des ordinateurs, présents sur le réseau Bitcoin, possédant la puissance de calcul cryptographique (ratio de hachage) nécessaire au minage des blocs. Plus ce ratio est élevé :
- Plus le mineur a de chance de résoudre le problème mathématique complexe permettant d'ajouter son bloc candidat.
